 ...
 */
public class EntityNagaMinion extends EntityNaga implements ISummonedCreature {
	...
	public EntityNagaMinion(World world) {
		super(world);
	...
	protected void initEntityAI() {
		...
		this.targetTasks.addTask(2, new MMAINearestAttackableTarget<>(this, EntityLivingBase.class, 0, true, false, true, null));
