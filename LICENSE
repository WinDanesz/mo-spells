...
**The '*Mowzie's Mobs license*' below applies to all intellectual property which originate from / are derivatives of Mowzie's Mobs content and takes precedence over any custom licenses which might apply to the rest of this (the "Mo' Spells") project.

**This project _is not affiliated_ with the creators of the Mowzie's mod or the Electroblob's Wizardry mod, but was created by a third party (WinDanesz) to provide better compatibility between these projects.** 

**Mowzie's Mobs license**
